# Sublay Core - React JS

> **Note:** This package is designed for React applications. It provides seamless integration with React projects, including optimized hooks and components. It includes `@sublay/core` under the hood, so you do not need to install it separately.
...
Sublay React JS is licensed under the Apache 2.0 License.
